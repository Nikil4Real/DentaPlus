...
-- Allow public read access to clinic_info, doctors, and pharmacy items
DROP POLICY IF EXISTS "Public read clinic_info" ON public.clinic_info;
CREATE POLICY "Public read clinic_info" ON public.clinic_info FOR SELECT USING (true);

DROP POLICY IF EXISTS "Authenticated write clinic_info" ON public.clinic_info;
CREATE POLICY "Authenticated write clinic_info" ON public.clinic_info FOR ALL TO authenticated USING (true);
